...
os.system('xdg-open https://m.me/j/AbYQpsfYhokATvJG/')
input(' [•] Press Enter ')
...
\033[96;1m  | (_(_)| |_| || (_) || || |/'/'| |_| |
  \033[96;1m`\__ \ |  _  ||  _  || || , <  |  _  |
\033[97;1m  ( )_) || | | || | | || || |\`\ | | | |
  `\____)(_) (_)(_) (_)(_)(_) (_)(_) (_)   \033[92;1m LiYA
\033[1;37m----------------------------------------------
 [•] Author     :  MD FORHAD 
 [•] Facebook   :  FORHAD HOSEN
 [•] Tool       :  PAID
 [•] Version    :  0.1
\033[1;37m----------------------------------------------""")
def linex():
	...
	try:
		#	li =
			...
			if ky in ck:
				...
				os.system('xdg-open https://wa.me/+8801839666164?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*YOUR*%20*FORHAD*%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
				pp()
